...
module  clk_gate_buf_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //clk_gate_buf_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  clk_gate_buf_altclkctrl_0  (
    ena,
    inclk,
    outclk);
...
`endif
    ...
    clk_gate_buf_altclkctrl_0_sub  clk_gate_buf_altclkctrl_0_sub_component (
                .ena (ena),
                .inclk (sub_wire2),
                .outclk (sub_wire0));
