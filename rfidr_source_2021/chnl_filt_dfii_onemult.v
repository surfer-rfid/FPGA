...
//                                                                                //
// Filename: chnl_filt_dfii_onemult.v                                             //
...
module chnl_filt_dfii_onemult
    ...
    assign        adder1_out                =    {{6{in[15]}},in} + {adder2_out[20],adder2_out};
    assign        adder1_out_sat_blank    =    blank ? 18'sb0 : adder1_out_sat; //This does not come for free and actually saves LUT to remove. But may reduce range to do so.
    assign        adder2_out                =    {multr1_out[25],multr1_out[24:5]} - {multr2_out[25],multr2_out[24:5]};
    assign        adder3_out                =    {adder1_out_sat_blank[17],adder1_out_sat_blank[17:2]} - {stg2_reg[17],stg2_reg[17:2]};
    assign        out                        =    {{3{adder3_out[16]}},adder3_out};
